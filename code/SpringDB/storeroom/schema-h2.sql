...
ALTER TABLE PUBLIC.STUDENT_SCHEDULEDCLASS
    ADD CONSTRAINT PUBLIC.UKRRVJ0XAVODFIFGWFQB7SA402W UNIQUE (STUDENTS_ID, CLASSES_ID);
ALTER TABLE PUBLIC.SCHEDULEDCLASS
    ADD CONSTRAINT PUBLIC.FKCG4P6V03E9CL2JVRB8DEXTVD5 FOREIGN KEY (COURSE_ID) REFERENCES PUBLIC.COURSE (ID) NOCHECK;
ALTER TABLE PUBLIC.STUDENT_SCHEDULEDCLASS
    ADD CONSTRAINT PUBLIC.FKIGKWH9YGFXS5SSFT48ECED7L9 FOREIGN KEY (STUDENTS_ID) REFERENCES PUBLIC.STUDENT (ID) NOCHECK;
ALTER TABLE PUBLIC.STUDENT_SCHEDULEDCLASS
    ADD CONSTRAINT PUBLIC.FKQ4ABX6JNMBO10I6X1YFCAB5WJ FOREIGN KEY (CLASSES_ID) REFERENCES PUBLIC.SCHEDULEDCLASS (ID) NOCHECK;
